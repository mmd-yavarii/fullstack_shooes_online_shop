    ...
    return (
        <div className="rounded-xl p-2 sm:p-3 w-full sm:w-48 md:w-52  shadow-lg relative" style={{ border: '1px solid #00000017' }}>
            ...
            <div className="my-1.5 h-10 flex justify-center flex-col sm:my-2">
                {isDiscoun ? (
                    <>
                        <p className="line-through text-gray-400 text-[10px] sm:text-xs">{data.price} تومان</p>
                        <p className="text-red-500 font-bold text-xs sm:text-sm">{applyDiscount(data.price, data.discount)} تومان</p>
                    </>
                ) : (
